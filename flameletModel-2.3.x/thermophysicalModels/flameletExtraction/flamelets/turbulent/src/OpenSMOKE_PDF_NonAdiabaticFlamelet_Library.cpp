...
void OpenSMOKE_PDF_NonAdiabaticFlamelet_Library::SetShowFlamelet()
{
	_showFlamelet = true;
}
void OpenSMOKE_PDF_NonAdiabaticFlamelet_Library::SetShowFlameletLibrary()
{
...
void OpenSMOKE_PDF_NonAdiabaticFlamelet_Library::Read()
{
	...
	for(i=1;i<=_nphi;i++)
	{
		...
		{
			flamelet_libraries[i].Summary(i, _nphi);
		}
...
{
	cout << endl << endl << "Flamelet thermo loaded all libraries" << endl;

	cout << "Summarize the whole flamelet library: " << endl<< endl;
