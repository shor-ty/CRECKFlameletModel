...
void Foam::pdfFlameletThermo<BasicFlameletThermo, MixtureType>::calculate()
{
...
template<class BasicFlameletThermo, class MixtureType>
void Foam::pdfFlameletThermo<BasicFlameletThermo, MixtureType>::updateMassFractions()
{
...
template<class BasicFlameletThermo, class MixtureType>
void Foam::pdfFlameletThermo<BasicFlameletThermo, MixtureType>::errorMessage(const string message)
{
...
template<class BasicFlameletThermo, class MixtureType>
Foam::pdfFlameletThermo<BasicFlameletThermo, MixtureType>::pdfFlameletThermo
(
    const fvMesh& mesh,
    const word& phaseName
)
:
    heThermo<BasicFlameletThermo, MixtureType>(mesh, phaseName),
...

{
	...
	Info << "Thermo flamelet set the adiabat enthalpy for enthalpy defect calculation:" << endl << endl;
	{
		...
		Info << "     + Adiabat enthalpy oxidizer: " << HOxidizer << endl << endl;
	}
...
template<class BasicFlameletThermo, class MixtureType>
void Foam::pdfFlameletThermo<BasicFlameletThermo, MixtureType>::correct()
{
    if (debug)
    {
        Info<< "entering pdfFlameletThermo<BasicFlameletThermo, MixtureType>::correct()"
            << endl;
    }
    ...
    if (debug)
    {
        Info<< "exiting pdfFlameletThermo<BasicFlameletThermo, MixtureType>::correct()"
            << endl;
    }
}
